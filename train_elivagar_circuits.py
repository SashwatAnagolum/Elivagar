...
def main():  
    ...
    parser.add_argument('--noise_importance', type=float, default=0.5,
                        help='the relative importance of circuit CNR scores')

    parser.add_argument('--num_data_for_rep_cap', default=None, type=int,
                        help='number of data points used to compute representational capacity')

    parser.add_argument('--num_params_for_rep_cap', default=None, type=int,
                        help='number of parameter vectors used to compute representational capacity')
    ...
    parser.add_argument('--num_candidates_per_circ', default=100, type=int,
                        help='number of candidate circuits to evaluate for every circuit trained')
    ...
    train_elivagar_circuits(args.circs_dir, args.dataset, args.encoding_type, 
                            ...
                            args.num_qubits, num_meas_qubits,
