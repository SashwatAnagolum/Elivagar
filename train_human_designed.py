...
def main():
    ...
    parser.add_argument('--num_qubits', default=None, help='number of qubits used by the generated circuit')
    parser.add_argument('--num_embed_layers', default=None, help='number of embedding layers in the generated circuit')
    parser.add_argument('--num_var_layers', default=None, help='number of variational layers in the generated circuit')
    parser.add_argument('--num_epochs', default=50, help='number of epochs to train the generated circuit for')
    ...
    circ_gates, gate_params, inputs_bounds, weights_bounds = convert_human_design_circ_to_gate_circ(
        args.num_qubits, args.encoding_type, args.var_layer_type, args.num_embed_layers, args.num_var_layers)
    ...
    train_human_designed_circuit(args.save_dir, args.num_qubits, args.num_epochs,
