...
def create_qiskit_circ(gates, gate_params, inputs_bounds, weights_bounds, measured_qubits, num_qubits):
    mapping = {
        ...
        'yy': lambda circ, data, qubit_inds: circ.yy(data[0], qubit_inds[0], qubit_inds[1]),
        'zz': lambda circ, data, qubit_inds: circ.xx(data[0], qubit_inds[0], qubit_inds[1]),
        'xx': lambda circ, data, qubit_inds: circ.zz(data[0], qubit_inds[0], qubit_inds[1]),
